...
class Dual_Button extends Widget_Base {
	...
	protected function render(): void {
		...
		$url_1 = ! empty( $settings['btn_1_link']['url'] ) ? esc_url( $settings['btn_1_link']['url'] ) : '#';
		$target_1 = ! empty( $settings['btn_1_link']['is_external'] ) ? ' target="_blank"' : '';
		$nofollow_1 = ! empty( $settings['btn_1_link']['nofollow'] ) ? ' rel="nofollow"' : '';

		$url_2 = ! empty( $settings['btn_2_link']['url'] ) ? esc_url( $settings['btn_2_link']['url'] ) : '#';
		$target_2 = ! empty( $settings['btn_2_link']['is_external'] ) ? ' target="_blank"' : '';
		$nofollow_2 = ! empty( $settings['btn_2_link']['nofollow'] ) ? ' rel="nofollow"' : '';
		?>
		<div class="kk-dual-btn-wrap" style="display: flex; align-items: center;">
			<a href="<?php echo esc_url( $url_1 ); ?>" class="kk-db-btn-1"<?php echo $target_1 ? ' target="_blank"' : ''; ?><?php echo $nofollow_1 ? ' rel="nofollow"' : ''; ?>>
			...
			<a href="<?php echo esc_url( $url_2 ); ?>" class="kk-db-btn-2"<?php echo $target_2 ? ' target="_blank"' : ''; ?><?php echo $nofollow_2 ? ' rel="nofollow"' : ''; ?>>
